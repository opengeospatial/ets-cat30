...
public class VerifyOpenSearchCoreTests extends TestCommon {
	...
	public static void initTestFixture() throws Exception {
		...
		Document osd = docBuilder
			.parse(VerifyOpenSearchCoreTests.class.getResourceAsStream("/opensearch/OpenSearchDescription-valid.xml"));
		...
		Document doc = docBuilder.parse(VerifyOpenSearchCoreTests.class.getResourceAsStream("/capabilities/basic.xml"));
		...
		emptyResponse = docBuilder
			.parse(VerifyOpenSearchCoreTests.class.getResourceAsStream("/rsp/GetRecordsResponse-empty.xml"));
	}
