/**
 * <p>
 * Includes tests covering capabilities required for <strong>Basic-Catalogue</strong>
 ...
 *
 * <ul>
 * <li><code>GetCapabilities</code>: Obtain information (service-related metadata) about
 * the capabilities of the service</li>
 * <li><code>GetRecordById</code>: Retrieve a representation of a catalog record by
 * identifier.</li>
 * <li><code>GetRecords</code>: Search catalog content and retrieve results using basic
 * filter criteria.</li>
 * </ul>
 *
 * <p>
