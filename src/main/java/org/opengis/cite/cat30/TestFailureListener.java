...
public class TestFailureListener extends TestListenerAdapter {
    ...
    public void onTestFailure(ITestResult result) {
        ...
        if (CommonFixture.class.isInstance(instance)) {
            ...
            String msgInfo = fixture.getMessageInfo(fixture.requestInfo);
            result.setAttribute("request", msgInfo);
            msgInfo = fixture.getMessageInfo(fixture.responseInfo);
            result.setAttribute("response", msgInfo);
        }
    }
