...
public class TemplateParamInfo {
     ...
     * @param isRequired A boolean value indicating whether or not the parameter
     * is required.
     */
     ...
     *
     * @return A instance of the parameter's type, or a zero-length string if it
     * has not been set.
     */
    ...
    public void setDefaultValue(Object defaultValue) {
        if (!this.type.isInstance(defaultValue)) {
            throw new IllegalArgumentException(
                    "Default value must be an instance of " + this.type.getName());
        }
